...
http.createServer((req, res) => {
    ...
    switch (req.url) {
        ...
        case '/contacto':
            res.write('-------------------\n');
            res.write('Titulo: Contáctanos\n');
            res.write('-------------------\n');
            res.write('Contenido: ¿Tenés algo para nosotros? Nos encanta escuchar a nuestros clientes. Si deseas contactarnos podés escrinos al siguiente email: dhmovies@digitalhouse.com o en las redes sociales. Envianos tu consulta, sugerencia o reclamo y será respondido a la brevedad posible. Recordá que también podés consultar la sección de Preguntas Frecuentes para obtener respuestas inmedatas a los problemas más comunes\n');
            res.write('----------------\n\n');
			res.end();
            break;
